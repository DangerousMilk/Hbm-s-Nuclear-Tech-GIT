...
public class ModBlocks {
	...
	private static void initializeBlock() {
		...
		steel_railing = new DecoBlock(Material.iron).setBlockName("steel_railing").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
		steel_railing_corner = new DecoBlock(Material.iron).setBlockName("steel_railing_corner").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
		steel_railing_straight = new DecoBlock(Material.iron).setBlockName("steel_railing_straight").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
		steel_railing_end = new DecoBlock(Material.iron).setBlockName("steel_railing_end").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
		steel_stairs = new DecoBlock(Material.iron).setBlockName("steel_stairs").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
