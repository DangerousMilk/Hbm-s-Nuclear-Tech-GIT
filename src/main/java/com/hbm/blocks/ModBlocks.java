...
public class ModBlocks {
	...
	public static Block steel_girder_wall;
	...
	private static void initializeBlock() {
		...
		steel_railing = new RailingBlock(Material.iron).setBlockName("steel_railing").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
		steel_railing_corner = new RailingBlock(Material.iron).setBlockName("steel_railing_corner").setStepSound(ModSoundTypes.grate).setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_steel");
	...
	private static void registerBlock() {
		...
		GameRegistry.registerBlock(steel_girder_wall, steel_girder_wall.getUnlocalizedName());
