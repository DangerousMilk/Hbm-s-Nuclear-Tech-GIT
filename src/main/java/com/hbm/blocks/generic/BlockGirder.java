...
public class BlockGirder extends Block {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemStack) {
		if(this == ModBlocks.steel_girder) return;
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
		...
		if(this == ModBlocks.steel_girder) {
			...
			if (meta == 1 || meta == 6 || meta == 3 || meta == 8) {
				this.setBlockBounds(6F * pixel, 0.0F, 0.0F, 10F * pixel, 1.0F, 1.0F);
			} else {
				this.setBlockBounds(0.0F, 0.0F, 6F * pixel, 1.0F, 1.0F, 10F * pixel);
			}
		} else if(this == ModBlocks.steel_girder_wall) {
			if (meta == 1 || meta == 6) {
				this.setBlockBounds(6F * pixel, 0.0F, 12F * pixel, 10F * pixel, 1.0F, 1.0F);
			} else if(meta == 2 || meta == 7) {
				this.setBlockBounds(0F, 0.0F, 6F * pixel, 4F * pixel, 1.0F, 10F * pixel);
			} else if(meta == 3 || meta == 8) {
				this.setBlockBounds(6F * pixel, 0.0F, 0F, 10F * pixel, 1.0F, 4F * pixel);
			} else if(meta == 4 || meta == 9) {
				this.setBlockBounds(12F * pixel, 0.0F, 6F * pixel, 1F, 1.0F, 10F * pixel);
			}
		}
	}
