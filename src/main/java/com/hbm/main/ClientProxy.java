...
public class ClientProxy extends ServerProxy {
	...
	public void registerBlockRenderer() {
		...
		RenderingRegistry.registerBlockHandler(new RenderRailing(ModBlocks.steel_stairs.getRenderType(), ResourceManager.steel_stairs));
		RenderingRegistry.registerBlockHandler(new RenderBlockDecoModel(ModBlocks.road_barrier.getRenderType(), ResourceManager.road_barrier));
